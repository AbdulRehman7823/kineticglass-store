...
function Footer() {
  return (
    <div><footer class="text-skin-base body-font">
      ...
      <div class="flex flex-wrap md:text-left text-center -mb-10 -mx-4">
        <div class="lg:w-1/6 md:w-1/2 w-full px-4">
          ...
          <nav class="list-none mb-10">
            <li>
              <a class="text-skin-base hover:text-gray-800">First Link</a>
            </li>
            <li>
              <a class="text-skin-base hover:text-gray-800">Second Link</a>
            </li>
            <li>
              <a class="text-skin-base hover:text-gray-800">Third Link</a>
            </li>
            <li>
              <a class="text-skin-base hover:text-gray-800">Fourth Link</a>
            </li>
          </nav>
        </div>
        <div class="lg:w-1/6 md:w-1/2 w-full px-4">
      ...
      <div class="container px-5 py-8 flex flex-wrap mx-auto items-center">
        <div class="flex md:flex-nowrap flex-wrap justify-center items-end md:justify-start">
          <div class="relative sm:w-64 w-40 sm:mr-4 mr-2">
            <label for="footer-field" class="leading-7 text-sm text-skin-base">Placeholder</label>
    ...
    <div class="bg-gray-100">
      <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
        <p class="text-gray-500 text-sm text-center sm:text-left">© 2020 Tailblocks —
          <a href="https://twitter.com/knyttneve" class="text-skin-base ml-1" target="_blank" rel="noopener noreferrer">@knyttneve</a>
        </p>
